...
export const TracingBeam = ({
  ...
  return (
    ...
    >
      <div className="absolute -left-6  md:left-0 xl:left-10 top-3">
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
          ...
          animate={{
            boxShadow:
              scrollYProgress.get() > 0
                ? "none"
                : "rgb(16 185 129) 0px 3px 8px",
          }}
          className="ml-[27px] h-4 w-4 rounded-full border-2 border-emerald-700 shadow-sm flex items-center justify-center"
        >
          <motion.div
            transition={{
              duration: 0.2,
            ...
            animate={{
              backgroundColor:
                scrollYProgress.get() > 0 ? "#10B981" : "var(--#10B981)",
              borderColor:
                scrollYProgress.get() > 0 ? "#10B981" : "var(--#10B981)",
            }}
            className="h-2 w-2  rounded-full border border-emerald-900 bg-emerald-600"
          />
        </motion.div>
        <svg
