...
const ButtonNoGlow = ({ children }: Props) => {
  return (
    <button className="bg-neutral-800 no-underline group cursor-pointer relative shadow-xl shadow-neutral-800 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block md:text-base lg:text-lg">
